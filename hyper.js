...
module.exports = {
  config: {
    ...
    fontFamily: '"Fira Code", Consolas, Menlo, "DejaVu Sans Mono", "Lucida Console", monospace',
    ...
    termCSS: '.xterm {line-height: 18px} .xterm-rows > div {display: block; line-height: 15px}',
